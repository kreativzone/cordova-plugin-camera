 ...
 * @property {Boolean} [useNativeInterface] - Android only option allowing the usage of a native camera activity (testing)
 */
...
cameraExport.getPicture = function(successCallback, errorCallback, options) {
    ...
    var useNativeInterface = !!options.useNativeInterface;

    var args = [quality, destinationType, sourceType, targetWidth, targetHeight, encodingType,
                mediaType, allowEdit, correctOrientation, saveToPhotoAlbum, popoverOptions, cameraDirection, useNativeInterface];
